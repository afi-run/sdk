...
/**
 * Deployed AfiReferralRouter per chain ID. Thin wrapper in front of Afi that
 * charges an optional referral fee (<= 0.10%) on the output token.
 * See referral.ts for calldata encoders. Deployed 2026-06-03.
 */
export const REFERRAL_ROUTER_ADDRESSES: Record<number, Address> = {
  1:     "0x47E7cE4237130F02202e081Efa1Fd338F23Ead77", // Ethereum
  56:    "0x7356960324a627994bb5959CF615DC5f2B38B738", // BSC
  130:   "0xcdC506dEA82FE7d034C0281564d0dbe49171D242", // Unichain
  8453:  "0x2dC7a3990618baa91c450521004F14A334BF47c6", // Base
  42161: "0x9DaD9322e196F734Fa25eC3b0db90387945B397C", // Arbitrum
}
...
/**
 * Full ABI of the AfiReferralRouter contract. See REFERRAL_ROUTER_ADDRESSES
 * for deployments and referral.ts for calldata encoders.
 */
export const AFI_REFERRAL_ROUTER_ABI = [
  {
    "type": "constructor",
    "inputs": [
      {
